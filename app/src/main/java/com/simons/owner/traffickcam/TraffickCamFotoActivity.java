...
public class TraffickCamFotoActivity extends AppCompatActivity {
    ...
    int photo_id = 0; // keeps track of photos taken
    ...
    {
        Toast.makeText(this, "Take another photo or press DONE to exit!", Toast.LENGTH_LONG).show();
    }
    ...
    {
        String path = getExternalFilesDir("photos") + "/" + (photo_id++) + ".jpg";
